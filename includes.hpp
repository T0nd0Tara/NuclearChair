...
#define vBLOCK_SIZE olc::vf2d{fBLOCK_SIZE, fBLOCK_SIZE}

#define MOB_POSES 9
#define MOB_SIZE olc::vi2d{16, 16}
#define MOB_FILE_SIZE olc::vi2d{MOB_SIZE.x * MOB_POSES, MOB_SIZE.y}

#define BULLET_FILE_SIZE olc::vi2d{16,16}
#define BULLET_SIZE (BLOCK_SIZE >> 1)
#define fBULLET_SIZE (float)BULLET_SIZE
#define vBULLET_SIZE olc::vf2d{fBULLET_SIZE, fBULLET_SIZE}
